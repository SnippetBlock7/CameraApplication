...
class MainActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        val photoFile= File(externalMediaDirs.firstOrNull(),"CameraApi - ${System.currentTimeMillis()}.jpg")
    ...
    override fun onRequestPermissionsResult(
        ...
        {
            Toast.makeText(this,"Accept the Camera Request",Toast.LENGTH_LONG).show()
        }
    }
